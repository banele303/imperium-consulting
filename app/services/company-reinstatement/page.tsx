  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <motion.section
        ...
        className="py-20 bg-gradient-to-r from-red-500 to-orange-600 text-white"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p
            ...
            className="mt-4 text-lg md:text-xl text-red-100 max-w-3xl mx-auto"
          >
            Restore your deregistered company to active status and regain its legal standing.
          </motion.p>
        </div>
      </motion.section>
            ...
            <Card className="bg-white rounded-xl shadow-xl sticky top-24">
              ...
              <CardContent className="space-y-6">
                  <div className='p-4 rounded-lg border border-green-500 bg-green-50'>
                    ...
                    <p className="text-3xl font-bold text-green-600 my-2">R900</p>
                ...
                <div className="text-center">
                  <Link href="/contact" className="text-sm text-green-600 hover:underline">
                    Get an Assessment <ArrowRight className="inline h-4 w-4" />
                  </Link>
                </div>
              </CardContent>
            </Card>
