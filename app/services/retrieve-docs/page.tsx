  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <motion.section
        ...
        className="py-20 bg-gradient-to-r from-blue-400 to-cyan-500 text-white"
      >
            ...
            <Card className="bg-white rounded-xl shadow-xl sticky top-24">
              ...
              <CardContent className="space-y-6">
                  <div className='p-4 rounded-lg border border-green-500 bg-green-50'>
                    <h4 className="font-bold text-lg text-gray-800">Document Retrieval</h4>
                    <p className="text-3xl font-bold text-green-600 my-2">R240</p>
                    <p className="text-sm text-gray-600">Per document set.</p>
                ...
                <div className="text-center">
                  <Link href="/contact" className="text-sm text-green-600 hover:underline">
                    Unsure what you need? <ArrowRight className="inline h-4 w-4" />
                  </Link>
                </div>
              </CardContent>
            </Card>
