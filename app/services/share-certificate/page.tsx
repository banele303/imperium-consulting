...
export default function ShareCertificatePage() {
  const features = [
    "Professional design of share certificates.",
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <motion.section
        ...
        className="py-20 bg-gradient-to-r from-gray-700 to-gray-900 text-white"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Formalize ownership in your company with professionally issued share certificates.
          </motion.p>
        </div>
      </motion.section>
            ...
            <Card className="bg-white rounded-xl shadow-xl sticky top-24">
              ...
              <CardContent className="space-y-6">
                  <div className='p-4 rounded-lg border border-green-500 bg-green-50'>
                    <h4 className="font-bold text-lg text-gray-800">Share Certificate Service</h4>
                    <p className="text-3xl font-bold text-green-600 my-2">R350</p>
                    <p className="text-sm text-gray-600">Per certificate issued.</p>
                ...
                <div className="text-center">
                  <Link href="/contact" className="text-sm text-green-600 hover:underline">
                    Bulk Orders? Contact Us <ArrowRight className="inline h-4 w-4" />
                  </Link>
                </div>
              </CardContent>
            </Card>
