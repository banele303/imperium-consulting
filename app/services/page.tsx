...
const allServices = [
  ...
  { icon: RefreshCw, title: "Company Re-instatement", price: "R2300", description: "Restore deregistered company status.", category: "Corporate", href: "/services/company-reinstatement" },
