...
const allServices = [
  ...
  { icon: RefreshCw, title: "Company Re-instatement", price: "R2300", description: "Restore deregistered company status with full support.", category: "Corporate", href: "/services/company-reinstatement" },
  { icon: RefreshCw, title: "Company Reinstatement", price: "R800", description: "Restore deregistered company status (basic service).", category: "Corporate", href: "/services/company-reinstatement-basic" },
